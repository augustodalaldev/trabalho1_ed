...
BufferBits::BufferBits(FILE *arquivo) : arquivo(arquivo),
                                        byte(0),
                                        n(0)
{
}
...
BufferBitsLeitura::BufferBitsLeitura(FILE *f) : BufferBits(f)
{
}
...
BufferBitsEscrita::BufferBitsEscrita(FILE *f) : BufferBits(f)
{
}
